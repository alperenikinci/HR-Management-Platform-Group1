...
public enum ErrorType {
    ...
    EMAIL_NOT_FOUND(2111,"Bu email'e ait bir kullanici bulunamadi.",HttpStatus.BAD_REQUEST),
    WEBSITE_MANAGER_NOT_CREATED(2113,"WebsiteManager Olusturulamadi",HttpStatus.BAD_REQUEST),
